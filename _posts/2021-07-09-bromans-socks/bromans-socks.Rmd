...
p_st_posterior_grid <- plot_sock_grid(st_posterior_grid %>% filter(rho <= 30, sigma <= 20), posterior)
print(st_posterior_grid)
```

```{r preview-plot,   echo = FALSE, eval = FALSE}
# save image for preview
p_preview <- plot_sock_grid(st_posterior_grid %>% filter(rho <= 30, sigma <= 20), posterior) +
...
ggsave('img/socks-posterior.png', plot = p_preview, device = 'png', width = 14, height = 13, units = "cm")
```
