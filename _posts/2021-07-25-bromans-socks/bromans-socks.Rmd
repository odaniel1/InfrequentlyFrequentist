...
The plot demonstrates why a frequentist, maximum likelihood estimate (MLE) approach to solving this problem is bound to fail: the likelihood is maximised, and equal to 1, whenever $\sigma \geq 11$, and $\rho = 0$.
...
animated_posterior <- ggplot(iterated_posterior %>% filter(n <= 100)) +
